...
from service.scaled_executor_service import scaling_executor_node
...
def build_ml_graph():
    ...
    graph.add_node("scaling_executor",scaling_executor_node)
    ...
    graph.add_edge("scaling_plan","scaling_executor")
    graph.add_edge("scaling_executor",END)
